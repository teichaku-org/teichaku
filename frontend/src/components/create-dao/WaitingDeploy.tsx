import { CreateDAOName, CreateDAOFirstProject, CreateDAORewardTokenAddress, CreateDAORewardTokenContributorAmount, CreateDAORewardTokenReviewerAmount, CreateDAOSprintDuration, CreateDAODescription, CreateDAOAvatar } from "@/domains/atoms/CreateDaoAtom"
...
export const WaitingDeploy = () => {
    ...
    return <Stack>
        <Center>
            {loading && <Loader color="violet" size="xl" />}
        </Center>
        <Center>
            <Text>
                {t.CreateDao.Complete.Wait}
            </Text>
        </Center>
        <Center>
            <Text color="red">
