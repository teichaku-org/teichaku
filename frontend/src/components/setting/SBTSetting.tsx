...
export const SBTSetting = () => {
  ...
  const form = useForm({
      ...
      validate: {
        nftAddress: (value) => (value != "" && !ethers.utils.isAddress(value)? t.CreateDao.Step2.InvalidTokenAddress : null),
      },
  ...
  return (
    <Paper p="lg" mb="lg">
      ...
      <TextInput placeholder="0x..." label={t.Settings.SBTSetting.SBTAddressInput.Label} mb="sm" {...form.getInputProps("nftAddress")}/>
