...
import { Anchor, Avatar, createStyles, Group, Paper, Spoiler, Text } from "@mantine/core"
  ...
  return (
    <Spoiler maxHeight={400} showLabel="Show more" hideLabel="Hide">
      {props.comments.map((c) => {
        ...
        return (
          <Paper key={c.author + props.pollId} withBorder radius="md" p="md" mb="md">
            <Group>
              <Avatar color="cyan" radius="xl">
                {c.author?.substring(2, 4)}
              </Avatar>
              <div>
                <Text span size="xs">
                  by{" "}
