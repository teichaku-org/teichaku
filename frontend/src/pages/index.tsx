...
const Home = () => {
  ...
  const slideUrl = () => {
    if (locale === "ja") {
      return "https://docs.google.com/presentation/d/e/2PACX-1vRmpQhvUrfcLA3xinEjl5icfdMnJGxKFiRjNTawev8bSJztTu3VRZCGRUAcA4m1UlHRtQER3ENDWDQ3/embed?start=false&loop=false&delayms=3000"
    } else {
