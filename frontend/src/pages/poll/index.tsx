...
const Poll = () => {
    ...
    const interval = useInterval(() => {
        console.log("call")
        if (endTimeStamp)
            setLeftTimeStr(getLeftTime(endTimeStamp))
    ...
    return <Container >
        ...
        <Text mb="lg">The poll will end in <Text size="xl" span variant="gradient" gradient={{ from: "blue", to: "grape" }}>{leftTimeStr}</Text></Text>
        <Text mb="lg">
