...
const Page = () => {
    ...
    const durationDay = pollDetail ? (pollDetail.endTimeStamp.getTime() - pollDetail.startTimeStamp.getTime()) / (60 * 60 * 24 * 1000) : 7;
            ...
            <Table horizontalSpacing="md" verticalSpacing="sm" fontSize="lg">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{voterReward || 0} <b>{tokenSymbol}</b></td>
                    </tr>

                    <tr>
                        <td>{t.Settings.PollDuration.Title}</td>
                        <td>{durationDay} {t.Settings.PollDuration.DayUnit}</td>
                    </tr>
                </tbody>
            </Table>
        );
                ...
                {deployErrorMessage ?
                    <Center mt="xl">
                        <Button
                            ...
                            size="xl" variant="gradient"
                            gradient={{ deg: 0, from: "blue", to: "grape" }}
                        >{t.CreateDao.Complete.Retry}</Button>
                    </Center>
                    : <Center>
                        <Center mt="xl">
                            <Button
