...
export const setStartTimeStamp = functions.region("asia-northeast1").https.onRequest(async (req, res) => {
  ...
  if (req.method === "OPTIONS") {
    ...
    await poll.setStartTimeStamp(requestData.pollId, requestData.startTimeStamp)
